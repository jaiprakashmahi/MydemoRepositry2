...
$member_name = $_SESSION['owner_name'] ?? '';
$state = $_SESSION['state'] ?? '';
$district = $_SESSION['district'] ?? '';

// 0. Count centers
$stmt = $conn->prepare("SELECT COUNT(*) FROM center_details WHERE state = ? AND district = ?");
$stmt->bind_param("ss", $state, $district);
$stmt->execute();
$stmt->bind_result($total_centers);
$stmt->fetch();
$stmt->close();

// 1. Fetch all center names in the member's state and district
$center_names = [];
...
if (!empty($center_names)) {
    ...
    // Payment total
    $stmt = $conn->prepare("SELECT SUM(price) FROM students WHERE study_center IN ($placeholders)");
    $stmt->bind_param($types, ...$center_names);
    $stmt->execute();
    ...
    // Unique course count
    $stmt = $conn->prepare("SELECT COUNT(DISTINCT course_name) FROM students WHERE study_center IN ($placeholders)");
    $stmt->bind_param($types, ...$center_names);
    $stmt->execute();
    $stmt->bind_result($courses_count);
    $stmt->fetch();
    $stmt->close();
}

// ✅ Commission calculation (must be outside the if-block)
$commissionRates = [
    'Node' => 3,
    'Zonal Manager' => 5,
    'Dristic Co-Ordinator' => 10,
    'Block Co-Ordinator' => 15
];

$commission_rate = $commissionRates[$member_type] ?? 0;
$commission_amount = ($payment_count * $commission_rate) / 100;
...
<head>
	...
	<!-- Page Title Here -->
	<title>Welcome To Sharnay Institute Dashboard</title>
     ...
     <?php include 'menu.php';?>
								...
								<div class="row">
									<div class="col-xl-3 col-6">
										<div class="content-box">
											...
											<div class="chart-num">
												<p>Students</p>
												<h2 class="font-w700 mb-0"><?php echo $student_count; ?></h2>
											</div>
										</div>
									</div>
									<div class="col-xl-3 col-6">
										<div class="content-box">
											...
											<div class="chart-num">
												<p>Center</p>
												 <h2 class="font-w700 mb-0"><?php echo $total_centers; ?></h2>
											</div>
										</div>
									</div> 
									<div class="col-xl-3 col-6">
										<div class="content-box">
											...
											<div class="chart-num">
												<p>Amount</p>
												 <h2 class="font-w700 mb-0">₹<?php echo number_format($payment_count, 2); ?></h2>
											</div>
										</div>
									</div>
									<div class="col-xl-3 col-6">
										<div class="content-box">
											...
											<div class="chart-num">
                                                <p>Commission (<?php echo $commission_rate; ?>%)</p>
                                                <h2 class="font-w700 mb-0">₹<?php echo number_format($commission_amount, 2); ?></h2>
                                            </div>
										</div>
									</div>
									<!-- <div class="col-xl-3 col-6">
										<div class="content-box">
											<div class="chart-num d-flex align-items-center">
											<div class="ruppe icon-box icon-box-xl bg-dark me-3">
							...
							<div class="card-header pb-0 border-0 flex-wrap">
								<div class="mb-2 mb-sm-0">
									<div class="chart-title mb-3">
										<h2 class="heading">Sharnay Performance</h2>	
									</div>
								</div>
								<div class="p-static">
					...
					<div class="col-xl-6">
						<div class="card h-auto">
							<div class="card-header border-0 pb-0 flex-wrap">
								<h4 class="heading mb-3 mb-sm-0">Sharnay Overview</h4>
					...
					<div class="col-xl-4 wow fadeInUp" data-wow-delay="1.5s">
						<div class="card">
							<div class="card-header pb-0 border-0 flex-wrap">
								<div>
									<div class="mb-3">
										<h2 class="heading mb-0">Sharnay Calendar</h2>	
									</div>
								</div>
							</div>
		...
		***********************************-->
		<div class="footer footer-outer">
			<div class="copyright">
				<p>Copyright © Designed &amp; Developed by <a href="" target="_blank">RKVIT Pvt. Ltd.</a> 2023</p>
			</div>
		</div>
