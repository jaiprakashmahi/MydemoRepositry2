							...
							<li class="nav-item">
							    <div class="dropdown header-profile2">
							        <a class="nav-link ms-0" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							            <div class="header-info2 d-flex align-items-center">
							                <div class="d-flex align-items-center sidebar-info">
							                    <!-- You can place an icon or profile picture here if needed -->
							                    <img src="images/logo.png" alt="Profile" style="width:30px; height:30px; border-radius:50%; margin-right:10px;">
							                </div>
							                <span>
											    <span>
												   <?= htmlspecialchars($center_name) ?>
												</span>
							            </div>
							        </a>
							        ...
							        <ul class="dropdown-menu dropdown-menu-end">
							        	<li><a href=""> <?php echo isset($_SESSION["center_name"]) ? htmlspecialchars($_SESSION["center_name"]) : 'Guest'; ?></a></li>
							            <li><a class="dropdown-item" href="index.php">My Profile</a></li>
							            <li><a class="dropdown-item" href="center_logout.php">Logout</a></li>
							        </ul>
							    </div>
							</li>
			...
			<div class="dlabnav-scroll">	
				<ul class="metismenu" id="menu">
					...
					<ul aria-expanded="false">
						...
						<!-- <li><a href="add-courses.php">Add New Courses</a></li> -->
					...
					<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
						<i class="material-symbols-outlined">person</i>
						<span class="nav-text">Notifaction</span>
					</a>
					<ul aria-expanded="false">
						<li><a href="#">Notifaction</a></li>
				...
				<div class="copyright">
					<p><strong>Sharnay Institute Dashboard</strong></p>
					<p class="fs-12">Made with <span class="heart"></span> by RKV</p>
				</div>
			</div>
        </div>