											...
											<tr>
												<td>
												  ...
												  <td><?= htmlspecialchars($row['student_code']) ?></td>
												    ...
												    <td class="text-end">
												        <a href="Certificate_Creation_Form.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-primary">Generate</a>
												    </td>
													<td><a href="certificate.php?id=<?= $row['id'] ?>" class="btn btn-success btn-sm">View Marksheet</a></td>
													<td><a href="course_certificate.php?id=<?= $row['id'] ?>" class="btn btn-success btn-sm">View Certifacate</a></td>
