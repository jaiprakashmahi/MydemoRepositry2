...
if (isset($_GET['id'])) {
    ...
    // Step 1: Get center details (including state_id and district_id)
    ...
    if ($result->num_rows > 0) {
        ...
        // Step 2: Get state name
        $state_name = '';
        $stmt_state = $conn->prepare("SELECT name FROM states WHERE id = ?");
        $stmt_state->bind_param("i", $center['id']);
        $stmt_state->execute();
        ...
        // Step 3: Get district name
        $districts_name = '';
        $stmt_dist = $conn->prepare("SELECT name FROM districts WHERE id = ?");
        $stmt_dist->bind_param("i", $center['id']);
        $stmt_dist->execute();
        $result_dist = $stmt_dist->get_result();
        if ($row = $result_dist->fetch_assoc()) {
            $districts_name = $row['name'];
        }
        $stmt_dist->close();
								...
								<div class="d-flex justify-content-between">
									<div class="user">
										<div class="user-media">
											<img src="uploads/<?php echo $center['photo']; ?>" alt="" class="avatar avatar-xxl">
										</div>
										<div>                                            
											<p class="text-primary font-w600">Center Name</p>
											<h2 class="mb-0"><?php echo $center['center_name']; ?></h2>
										</div>
									</div>
									...
									<div class="col-xl-3 col-xxl-6 col-sm-6">
										<ul class="student-details">
											...
											<li>
												...
												<h5 class="mb-0"><?php echo $center['owner_name']; ?></h5>
											</li>
										</ul>
									</div>
									<div class="col-xl-3 col-xxl-6 col-sm-6">
										...
										<ul class="student-details">
											...
											<li><span>Address:</span><h5 class="mb-0"> <?php echo $districts_name; ?>, <?php echo $state_name ?>,  <?php echo $center['pincode']; ?></h5></li>
										</ul>
									</div>
									<div class="col-xl-3 col-xxl-6 col-sm-6">
										<ul class="student-details">
											...
											<li><span>Phone:</span><h5 class="mb-0"><?php echo $center['phone']; ?></h5></li>
										</ul>
									</div>
									<div class="col-xl-3 col-xxl-6 col-sm-6">
										<ul class="student-details">
											...
											<li><span>Email:</span><h5 class="mb-0"><?php echo $center['email']; ?></h5></li>
										</ul>
									</div>
									...
									<table id="example-payment" class="display" style="min-width: 845px">
										...
										<tbody>
											<tr>
												<td>
													<div class="d-flex align-items-center">	
														...
														<div class="ms-3">
															<h6 class="mb-0 font-w600">#123456789</h6>
														</div>
													</div>
												</td>
												<td>
											...
											<tr>
												...
												<td class="pe-3">
													<span class="text-warning font-w600">Pending</span>
												</td>
											</tr>
											<tr>
												<td>
											...
											<!-- <tr>
												<td>
													<div class="d-flex align-items-center">	
														...
														<div class="ms-3">
															<h6 class="mb-0 font-w600">#1234567811</h6>
														</div>
													</div>
												</td>
												<td>
...
<!-- Mirrored from akademi.dexignlab.com/xhtml/student-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Jan 2025 10:09:33 GMT -->
</html>